...
(1, 'Angeline D. Santos', '', '', '', 'Female', 'ACTIVE', 'VISIBLE', 'Doctor2.png'),
(2, 'Eduardo C. Garcia', '', '', '', 'Male', 'ACTIVE', 'VISIBLE', 'Doctor1.png'),
(3, 'Rosario U. Santiago', '', '', '', 'Male', 'ACTIVE', 'VISIBLE', 'Doctor1.png'),
(4, 'May Ann J. Tan', '', '', '', 'Female', 'ACTIVE', 'VISIBLE', 'Doctor2.png'),
(5, 'Pedro S. Villanueva', '', '', '', 'Male', 'ACTIVE', 'VISIBLE', 'Doctor1.png'),
(6, 'Nelia L. Reyes', '', '', '', 'Female', 'ACTIVE', 'HIDDEN', 'Doctor2.png'),
(7, 'Felicia D. Espinosa', '', '', '', 'Female', 'ACTIVE', 'VISIBLE', 'Doctor2.png'),
(8, 'Danica R. Dela Cruz', '', '', '', 'Female', 'ACTIVE', 'VISIBLE', 'Doctor2.png'),
(9, 'Oliver H. Dadole', '', '', '', 'Male', 'ACTIVE', 'VISIBLE', 'Doctor1.png'),
(10, 'Nathan R. Lee', '', '', '', 'Male', 'ACTIVE', 'VISIBLE', 'Doctor1.png'),
(11, 'Alfelor france', '', '', '', '', 'ACTIVE', 'UNHIDE', NULL);
